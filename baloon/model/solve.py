...
try:
    from baloon.model.atmosphere import air_density_at_height
    from baloon.model.gas import (
        calculate_gas_density_at_altitude,
        calculate_hot_air_density
    )
    from baloon.model.materials import (
        get_material_density,
        get_material_stress_limit,
        get_material_permeability,
        calc_stress
    )
    from baloon.model.shapes import get_shape_dimensions_from_volume
    from baloon.constants import (
        T0, GAS_CONSTANT, GRAVITY
    )
except ImportError:
    from model.atmosphere import air_density_at_height
    from model.gas import (
        calculate_gas_density_at_altitude,
        calculate_hot_air_density
    )
    ...
    from model.shapes import get_shape_dimensions_from_volume
